...
import (
	...
	"github.com/ghluuuuuu/gitlab-code-review-bot/internal/ocr/diff"
	...
	"github.com/ghluuuuuu/gitlab-code-review-bot/internal/ocr/stdout"
	"github.com/ghluuuuuu/gitlab-code-review-bot/internal/ocr/telemetry"
...
// UsageSnapshot is the aggregate LLM usage observed by a Runner.
...
func (r *Runner) notifyUsage() {
	if r.deps.OnUsage != nil {
		r.deps.OnUsage(UsageSnapshot{InputTokens: r.TotalInputTokens(), OutputTokens: r.TotalOutputTokens(), TotalTokens: r.TotalTokensUsed()})
	}
}
